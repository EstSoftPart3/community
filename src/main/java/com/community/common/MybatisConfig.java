...
@Configuration
@MapperScan(basePackages = {"com.community.fo.mybatis.mapper"}, sqlSessionFactoryRef = "sqlSessionFactory")
public class MybatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("/mybatis/mapper/fo/*.xml"));
